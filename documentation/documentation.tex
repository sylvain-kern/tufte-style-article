\documentclass[raggedright, twoside, 11pt]{tufte-style-article}
...
\widefig{figures/usa-census.png}{The US census map from data collected in 2010 -- \url{ecpmlangues.u-strasbg.fr}\\This is a wide figure, stretching from the innermost to the outermost margin.}{fig:figure-fullwidth}
...
\end{codebox}
The compilation times can be quite long, especially if there are many heavy code snippets,\margintext{I am still working to optimize the class by reducing the compilation time.} hopefully it is not a problem for most cases.
