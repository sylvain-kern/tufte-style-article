...
\item Create a \inlinecode{text}{tex\latex\} directory in the \texttt{texmf} one, and inside it, create a \inlinecode{latex}{tufte-style-article} folder.
...
\item Open \hologo{MiKTeX} console, go to \inlinecode{text}{Settings}, \texttt{Directories} tab. Click on \inlinecode{text}{add}, and enter yout \texttt{texmf} path.
\begin{codebox}{text}
C:\Users<you>\localtexmf	
\end{codebox}
