...
\item Create a \inlinecode{}{tex\latex\} directory in the \texttt{localtexmf} one, and inside it, create a folder named \inlinecode{tex}{tufte-style-article}.
...
\item Open \hologo{MiKTeX} console, go to \inlinecode{}{Settings}, \inlinecode{tex}{Directories} tab. Click on \inlinecode{}{add}, and enter yout \texttt{texmf} path.
\begin{codebox}{}
C:\Users\<you>\localtexmf
\end{codebox}

\item Finally, go to the \inlinecode{}{tasks} tab, and hit \inlinecode{}{Refresh file name database}.
...
% 	\bottomrule
% \end{tabularx}
% \sidecaption{Table des marées à Douarnenez du 23 au 26 juillet 2021, Service Hydrographique et Océanographique de la Marine, \url{maree.shom.fr}.\\This is a wide table, called with the \inlinecode{tex}{table*} environment. The caption is also a \inlinecode{tex}_\sidecaption{}_.\label{tab:table-wide}}
